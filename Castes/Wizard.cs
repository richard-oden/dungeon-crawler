...
namespace DungeonCrawler
{
    class Wizard : Caste
    {
        ...
        public Wizard()
        {
            ...
            Action = new TargetedAction("slow", "[target name] - Wizard Ability: Attack a target. If they fail a DEX check vs your INT, their DEX is reduced by your INT mod for 2 turns.", "major", slow);
        }
        ...
        private bool slow(string targetName)
        {
            ...
            if (SentientCreature.Attack(targetName))
            {
                ...
                if (target.AbilityCheck("DEX") < passiveIntelligence)
                {
